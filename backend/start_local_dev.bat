...
set CORS_ALLOWED_ORIGINS=http://localhost:3000,http://127.0.0.1:3000,http://localhost:5173,http://127.0.0.1:5173,https://timetrackermvrk.vercel.app,https://kwcow8kok4s448sw4s8wo8cc.5.78.137.10.sslip.io
set CSRF_TRUSTED_ORIGINS=http://localhost:3000,http://127.0.0.1:3000,http://localhost:5173,http://127.0.0.1:5173,https://timetrackermvrk.vercel.app,https://kwcow8kok4s448sw4s8wo8cc.5.78.137.10.sslip.io
